...
export interface Order { id: string; code: string; ownerKey: string; status: OrderStatus; paymentStatus: PaymentStatus; paymentMethod: "COD" | "MOMO" | "VNPAY" | "CARD"; currency: "VND"; subtotal: Vnd; shippingFee: Vnd; discountTotal: Vnd; grandTotal: Vnd; couponCode?: string; customerNote?: string; shippingMethod?: "STANDARD"; carrier?: string; trackingCode?: string; shippedAt?: Date; idempotencyKey: string; address: ShippingAddress; items: OrderLine[]; placedAt: Date }
