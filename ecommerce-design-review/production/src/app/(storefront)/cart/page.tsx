...
export default function CartPage() { return <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6"><div className="mb-10 flex items-end justify-between"><div><p className="text-xs font-semibold tracking-[.2em] text-[#c26b77]">MUA SẮM AN TÂM</p><h1 className="mt-2 font-serif text-4xl">Giỏ hàng</h1></div><a href="/products" className="text-sm text-[#ce7a85] underline">Tiếp tục mua sắm</a></div><CartClient/></main>; }
