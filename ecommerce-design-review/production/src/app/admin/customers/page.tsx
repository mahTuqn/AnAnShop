...
export default async function Page() { await requireAdminPageSession("/admin/customers", "customers.read"); return <AdminResourcePage resource={adminResources.customers} resourceKey="customers" />; }
