...
export function ProductEditor({ productId, initialData, categories = [] }: { productId: string; initialData?: any; categories?: { id: string; name: string }[] }) {
